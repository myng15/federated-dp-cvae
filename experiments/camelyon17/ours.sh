    ...
    for lr in "${learning_rates[@]}"; do
        for n_fedavg_rounds in "${n_fedavg_rounds_values[@]}"; do
            for epsilon in "${epsilons[@]}"; do
                ...
                base_chkpts_dir="chkpts/camelyon17/$backbone/s_frac=${s_frac}/${anonymizer}/${current_time}" 
                base_results_dir="results/camelyon17/$backbone/s_frac=${s_frac}/${anonymizer}/${current_time}"
