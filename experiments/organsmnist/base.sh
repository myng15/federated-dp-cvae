        ...
        for algorithm in "${algorithms[@]}"; do
            for fedavg_lr in "${fedavg_learning_rates[@]}"; do
                for n_rounds in "${num_rounds[@]}"; do
                    ...
                    base_chkpts_dir="chkpts/organsmnist/$backbone/s_frac=${s_frac}/${n_clients}_clients/${split_method}/alpha=${alpha}/fedavg/${current_time}" 
                    base_results_dir="results/organsmnist/$backbone/s_frac=${s_frac}/${n_clients}_clients/${split_method}/alpha=${alpha}/fedavg/${current_time}"
